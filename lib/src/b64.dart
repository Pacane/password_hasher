library password_hasher.b64;

import "dart:convert";
import "dart:typed_data";

String encodeBase64(List<int> bytes) {
  return const _Base64Encoder().convert(bytes);
}

List<int> decodeBase64(String input) {
  return const _Base64Decoder().convert(input);
}
 ...
 *
 */
class _Base64Encoder extends Converter<List<int>, String> {

  final bool urlSafe;
  final bool addLineSeparator;

  const _Base64Encoder([bool this.urlSafe = false, bool this.addLineSeparator = false]);
 ...
 * Based on [RFC 4648](http://tools.ietf.org/html/rfc4648)
 */
class _Base64Decoder extends Converter<String, List<int>> {
